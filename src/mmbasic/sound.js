...
exports.SOUND_KEYWORDS = void 0;
/** Audio output: tones, file playback, MIDI and streaming. */
exports.SOUND_KEYWORDS = [
    {
        name: "PLAY",
        kind: "command",
        category: "Sound",
        ...
        summary: "Plays tones, sound effects and audio files. An optional interrupt subroutine runs when playback finishes.",
        notes: [
    ...
    },
    {
        ...
        summary: "Plays a sine wave on each channel at the given frequency in Hz, for dur milliseconds.",
    ...
    },
    {
        ...
        summary: "Plays one of the built in waveform generators. Type is S (sine), Q (square), T (triangle), W (sawtooth), N (noise) or O (off).",
    ...
    },
    {
        ...
        summary: "Plays audio from a circular buffer that your program keeps filling, for streaming sources.",
    ...
    },
    {
        ...
        summary: "Waits for the next audio or frame period boundary, giving steady timing for animation and sound.",
        snippet: "SYNC",
    },
];
