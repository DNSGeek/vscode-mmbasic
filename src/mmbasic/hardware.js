...
exports.HARDWARE_KEYWORDS = [
    {
        ...
        snippet: "SETPIN ${1:GP0}, ${2|DIN,DOUT,AIN,OC,CIN,FIN,PIN,INTH,INTL,INTB,PWM,IR,OFF|}",
    },
    {
        name: "PIN",
        kind: "function",
        ...
        summary: "Reads or writes a pin. PIN(TEMP) reads the internal temperature sensor, PIN(BOOTSEL) the BOOTSEL button.",
        example: [
            "SETPIN GP25, DOUT",
            "PIN(GP25) = 1",
            "state = PIN(GP2)",
    ...
    },
    {
        ...
        summary: "Reads or writes several consecutive pins at once as a single binary value.",
        example: [
    ...
    },
    {
        ...
        summary: "Generates a single pulse on a digital output. Width is in milliseconds and may be fractional.",
    ...
    },
    {
        ...
        summary: "Measures the width of an incoming pulse in microseconds. Polarity 1 measures a high pulse, 0 a low one.",
    ...
    },
    {
        ...
        summary: "Hardware timed one shot: a trigger edge produces a delayed pulse on an output pin without CPU involvement.",
        snippet: "ONESHOT ${1:trigger}, ${2:sense}, ${3:output}, ${4:delay}, ${5:width}",
    },
    {
        name: "PWM",
        kind: "command",
        ...
        summary: "Starts PWM output on a channel. Duty cycle is a percentage, and each channel drives up to two pins (A and B).",
        notes: [
    ...
    },
    {
        ...
        summary: "Drives hobby servos on a PWM channel, using positions from -100 to 100.",
    ...
    },
    {
        ...
        category: "I/O pins",
        syntax: ["PIN( pin )"],
        summary: "A pin configured with SETPIN pin, FIN is read with PIN() and returns the measured frequency in Hz.",
        example: [
            "SETPIN GP1, FIN",
            "PAUSE 1000",
            'PRINT PIN(GP1); " Hz"',
    ...
    // ----------------------------------------------------------- timing / ints
    {
        ...
        summary: "Free running millisecond counter. Assigning to it resets or presets the count.",
        example: [
            "TIMER = 0",
            "DoSomethingSlow",
            'PRINT "took "; TIMER; " ms"',
    ...
    },
    {
        ...
        summary: "Calls a subroutine every 'period' milliseconds. Up to four independent tick timers (nbr 1 to 4).",
        example: [
            "SETTICK 500, Blink, 1",
            "DO : LOOP",
            "",
    ...
    },
    {
        ...
        category: "Timing",
        syntax: ["IRETURN"],
        summary: "Returns from an interrupt when the target was a line number or label.",
        obsolete: true,
        replacedBy: "END SUB",
    ...
    },
    {
        ...
        summary: "Restarts the processor if the program does not reset the watchdog within the timeout in milliseconds.",
        example: [
            "WATCHDOG 5000",
            "DO",
    ...
    },
    {
        ...
        summary: "Restarts the processor, sleeps for n seconds at low power, or changes the clock speed.",
    ...
    // --------------------------------------------------------------- ADC
    {
        ...
        summary: "High speed block sampling of the analog inputs straight into arrays.",
        notes: [
    ...
    // --------------------------------------------------------------- I2C
    {
        ...
        summary: "Master mode I2C bus. Speed is in kHz, timeout in milliseconds. Option 1 keeps the bus held for a repeated start.",
        notes: [
    ...
    // --------------------------------------------------------------- SPI
    {
        ...
        summary: "SPI master. The function form SPI(data) writes and reads one word in a single operation.",
    ...
    // ------------------------------------------------------------- 1-wire
    {
        ...
        summary: "Low level 1-Wire bus access. MM.ONEWIRE reports whether a device responded.",
    ...
    },
    {
        ...
        summary: "Reads a DS18B20 temperature sensor in degrees Celsius, blocking while it converts.",
    ...
    },
    {
        ...
        summary: "Starts a DS18B20 conversion without blocking. Read the result later with TEMPR().",
        example: [
            "TEMPR START GP6",
            "PAUSE 800",
            "PRINT TEMPR(GP6)",
    ...
    },
    {
        ...
        summary: "Reads a DHT22 (or DHT11) temperature and humidity sensor into two variables.",
    ...
    },
    {
        ...
        summary: "Measures distance in centimetres with an HC-SR04 style ultrasonic sensor.",
    ...
    },
    {
        ...
        summary: "Decodes NEC infrared remote codes into variables via an interrupt, or transmits a code.",
        example: [
            "SETPIN GP8, IR",
            "IR dev, key, GotKey",
            "",
    ...
    },
    {
        ...
        summary: "Scans a matrix keypad in the background and calls an interrupt when a key is pressed.",
    ...
    },
    {
        ...
        summary: "Reads or sets an external I2C real time clock and copies the value into TIME$ and DATE$.",
    ...
    },
    {
        ...
        summary: "Drives a chain of WS2812 addressable LEDs. Type is O, B, G or W depending on the colour order.",
        example: [
    ...
    },
    {
        ...
        summary: "Emits a precisely timed sequence of high and low periods on a pin, for custom one wire protocols.",
    ...
    // --------------------------------------------------------------- PIO
    {
        ...
        summary: "Assembles and runs programs on the RP2040 / RP2350 programmable I/O state machines.",
        notes: [
    ...
    },
    {
        ...
        summary: "Builds PIO configuration words and reads state machine status and FIFOs.",
